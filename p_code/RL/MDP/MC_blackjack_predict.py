...
"""
输出：
100%|██████████████████████████████████████████████████████████████████████████████| 200000/200000 [00:18<00:00, 10616.24it/s] 
总共200000局，玩家赢了64682局，和了12889局，输了122429局，胜率：0.32
"""
...
#将策略评估的结果进行图像化表示
#要表示玩家的价值函数，那么就是状态
#玩家的状态包括庄家的第一张牌，玩家的牌点数，以及是否有ace
#所以分为有ace和没有ace，x为庄家第一张牌，y为牌总点数，Z表示的是价值函数的值
...
"""
=========开始新一局==========发了2张牌(['Q', '3'])给庄家;庄家现在的牌:['Q', '3']
 发了2张牌(['4', '2'])给玩家;玩家现在的牌:['4', '2']
 玩家选择：继续叫牌；发了1张牌(['A'])给玩家;玩家现在的牌:['4', '2', 'A']
 玩家选择：继续叫牌；发了1张牌(['2'])给玩家;玩家现在的牌:['4', '2', 'A', '2']
 玩家选择：继续叫牌；发了1张牌(['4'])给玩家;玩家现在的牌:['4', '2', 'A', '2', '4']
 玩家选择：继续叫牌；发了1张牌(['6'])给玩家;玩家现在的牌:['4', '2', 'A', '2', '4', '6']
 玩家选择：继续叫牌；发了1张牌(['5'])给玩家;玩家现在的牌:['4', '2', 'A', '2', '4', '6', '5']
 玩家选择：停止叫牌；玩家爆点24输了，得分-1
==========本局结束====================开始新一局==========发了2张牌(['1', '1'])给庄家;庄家现在的牌:['1', '1']
 发了2张牌(['8', '7'])给玩家;玩家现在的牌:['8', '7']
 玩家选择：继续叫牌；发了1张牌(['1'])给玩家;玩家现在的牌:['8', '7', '1']
 玩家选择：继续叫牌；发了1张牌(['3'])给玩家;玩家现在的牌:['8', '7', '1', '3']
 玩家选择：继续叫牌；发了1张牌(['6'])给玩家;玩家现在的牌:['8', '7', '1', '3', '6']
 玩家选择：停止叫牌；玩家爆点25输了，得分-1
100%|██████████████████████████████████████████████████████████████████████████████████████████| 2/2 [00:00<00:00, 284.52it/s] 
总共2局，玩家赢了0局，和了0局，输了2局，胜率：0.00
"""
